---
title: "Upper Airway OSA Statistical Modeling (R)"
excerpt: "Statistical analysis workflow in R for evaluating airway morphometrics in Obstructive Sleep Apnea.<br/><img src='https://img.shields.io/badge/Tech-R_%7C_ggplot2_%7C_dplyr-blue'>"
...
### Overview
This project encapsulates the statistical data analysis pipeline used for my Master's graduation project and subsequent clinical publication. It processes raw patient demographic and clinical data (Age, BMI, AHI) alongside 3D CBCT morphometric measurements (Volume, Minimum Cross-Sectional Area, AP, LR dimensions).
