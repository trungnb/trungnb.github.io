...
### Tổng quan
Việc đo đạc 3D thủ công trong nha khoa vô cùng tốn thời gian. Với mong muốn tự học kiến thức cơ bản về thị giác máy tính, tôi đã viết một kịch bản Python thử nghiệm để tự động hóa việc nhận diện CEJ và tính tỷ lệ thân-chân răng từ file NIfTI. Dù mới ở bước đầu, dự án nhỏ này giúp tôi làm quen với các thuật toán trích xuất đặc trưng hình ảnh.

### Động lực thực hiện
Việc click chuột thủ công qua các mô hình 3D nha khoa để tìm các mốc giải phẫu như Đường nối men-ngà (CEJ) cực kỳ tốn thời gian. Tôi bắt đầu dự án này để xem liệu các thuật toán Python cơ bản có thể gánh vác phần việc nặng nhọc này và giảm thiểu sai số của con người hay không.
